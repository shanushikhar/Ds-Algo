...
class Car extends Vehicle {
    ...
    getName() {
        return 'It is a car: ' + this.name + " (coming from parent) .. " + this.myname + " -> " + super.getName();
    }
...
getVal(animal.getName())
getVal(animal.getBreed())
getVal('********')
getVal(animal.getSubname())
getVal(animal.getParentAnimalName())
getVal(animal.getAnimalBreed())
getVal(animal.getAnimalName())
